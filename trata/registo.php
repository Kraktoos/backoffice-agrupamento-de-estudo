...
header('Location: ' . $arrConfig['url_site'] . '/register.php?error=5');
...
//     header('Location: ' . $arrConfig['url_site'] . '/register.php?error=1');
//     exit();
// }

// if ($_POST["inputPassword"] != $_POST["inputPasswordConfirm"]) {
//     header('Location: ' . $arrConfig['url_site'] . '/register.php?error=2');
//     exit();
// }
...
//     header('Location: ' . $arrConfig['url_site'] . '/register.php?error=3');
//     exit();
// }
